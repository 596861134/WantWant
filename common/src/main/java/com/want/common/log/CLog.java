...
import com.want.common.log.clog.BaseLog;
import com.want.common.log.clog.FileLog;
import com.want.common.log.clog.JsonLog;
import com.want.common.log.clog.XmlLog;
...
public final class CLog {
    ...
    private static void printStackTrace() {
        ...
        for (String trace : traceString) {
            if (trace.contains("at com.living.vehicle.carservice.clog.CLog")) {
                continue;
            }
